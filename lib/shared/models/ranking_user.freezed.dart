...
mixin _$RankingUser {
 ...
 int get rank; String get id; String get fullName; String? get avatarUrl; int get totalPoints; Medal get medal;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,rank,id,fullName,avatarUrl,totalPoints,medal);

@override
String toString() {
  return 'RankingUser(rank: $rank, id: $id, fullName: $fullName, avatarUrl: $avatarUrl, totalPoints: $totalPoints, medal: $medal)';
}
...
@useResult
$Res call({
 int rank, String id, String fullName, String? avatarUrl, int totalPoints, Medal medal
});
...
/// Create a copy of RankingUser
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? rank = null,Object? id = null,Object? fullName = null,Object? avatarUrl = freezed,Object? totalPoints = null,Object? medal = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int rank,  String id,  String fullName,  String? avatarUrl,  int totalPoints,  Medal medal)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RankingUser() when $default != null:
return $default(_that.rank,_that.id,_that.fullName,_that.avatarUrl,_that.totalPoints,_that.medal);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int rank,  String id,  String fullName,  String? avatarUrl,  int totalPoints,  Medal medal)  $default,) {final _that = this;
switch (_that) {
case _RankingUser():
return $default(_that.rank,_that.id,_that.fullName,_that.avatarUrl,_that.totalPoints,_that.medal);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int rank,  String id,  String fullName,  String? avatarUrl,  int totalPoints,  Medal medal)?  $default,) {final _that = this;
switch (_that) {
case _RankingUser() when $default != null:
return $default(_that.rank,_that.id,_that.fullName,_that.avatarUrl,_that.totalPoints,_that.medal);case _:
  return null;
...
class _RankingUser implements RankingUser {
  const _RankingUser({required this.rank, required this.id, required this.fullName, this.avatarUrl, required this.totalPoints, this.medal = Medal.hierro});
...
/// Create a copy of RankingUser
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? rank = null,Object? id = null,Object? fullName = null,Object? avatarUrl = freezed,Object? totalPoints = null,Object? medal = null,}) {
